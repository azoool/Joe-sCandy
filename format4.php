<?php
    ...
    $order=$_SESSION['tri'];
    if($order == 'nbVisite desc'){
        $preferer = "selected='selected'";
    }
    else if($order=='Reference desc'){
    ...
    echo"<div id='divTri'>"
                ."<form id='formTri' action=\"format.php?ID=$id\" method='post' name='onglet' enctype='multipart/form-data' align='left'>"
                    ...
                    ."<select onChange='onglet.submit()' name='choixTri'>"
                        ."<option $promo value='Promotion desc'>Promotion</option>"
...
////////////////////////////////////////////OPTION SELECTIONNE////////////////////////////////
    ...
    if($maRecherche!=''){
        ...
        //gestion query
        $order=$_SESSION['tri'];
        $query = 'SELECT * FROM bonbons where Promotion!=0';
        if($mescouleurs!='' || $mesgouts!=''){
            $query = $query." and $mescouleurs $mesgouts ";
        }
        if($order!=''){
            ...
            "<div class='show' align='center'>"
                ...
                ."</a>"
                    ."<a href='updatePreferer.php?Reference=$reference' class='name'><font color='black'>$nom</font></a>"
                        . "<div class='pastillePromo' style='background-color: $couleurProm'; '>"
